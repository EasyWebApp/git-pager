...
(function (factory) {
    ...
    if ((typeof define === 'function')  &&  define.amd)
        define('select-input', ["web-cell"], factory);
    else if (typeof module === 'object')
        return  module.exports = factory.call(global,require('web-cell'));
    else
        return  this['select-input'] = factory.call(self,this['web-cell']);
                ...
                function(_initialize, _HTMLElement) {
                    var SelectInput =
                        ...
                        (function(_HTMLElement2) {
                            _inherits(SelectInput, _HTMLElement2);
                            ...
                            function SelectInput() {
                                ...
                                ((_temp = _this = _possibleConstructorReturn(
                                    this,
                                    _getPrototypeOf(SelectInput).call(this)
                                )),
                                _initialize(
                        ...
                        d: [
                            ...
                            },
                            {
                                ...
                                value: function value() {
                                    ...
                                    input();
                                    new MutationObserver(input).observe(
                                        origin,
                                        {
                                            childList: true
                                        }
                            ...
                            },
                            {
                                kind: 'method',
                                decorators: [
                                    (0, _webCell.on)('change', ':host input')
                                ],
                                key: 'output',
                                value: function value(_ref) {
                                    var _value = _ref.target.value;
                                    var origin = this.origin;
                                    origin.value = _value;
                                    (0, _webCell.trigger)(
                                        origin,
